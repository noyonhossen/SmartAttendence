...
public class StudentDetails_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        total = (TextView)findViewById(R.id.totalAttendedStudentsID) ;

        studentList = new ArrayList<>();
        customAdapter = new CustomAdapter2(StudentDetails_1.this,studentList);
