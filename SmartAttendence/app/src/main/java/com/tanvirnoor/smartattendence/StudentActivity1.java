...
public class StudentActivity1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null) {
            bvalue = bundle.getString("Course");
        }
        ...
        button = (Button)findViewById(R.id.buttonSendID);
        editText=(EditText)findViewById(R.id.edittextPasswordIDStudent);
    ...
    //barcode end
        if(bvalue.equals("Course_1")){
            databaseReference = FirebaseDatabase.getInstance().getReference("Password1");
            databaseReferenceAttendence = FirebaseDatabase.getInstance().getReference("Attendence1");
        }
        else if(bvalue.equals("Course_2")){
        ...
        else if(bvalue.equals("Course_3")){
            databaseReference = FirebaseDatabase.getInstance().getReference("Password3");
            databaseReferenceAttendence = FirebaseDatabase.getInstance().getReference("Attendence3");
        }
        else if(bvalue.equals("Course_4")){
            databaseReference = FirebaseDatabase.getInstance().getReference("Password4");
            databaseReferenceAttendence = FirebaseDatabase.getInstance().getReference("Attendence4");
        }
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.buttonSendID){
            String pass = editText.getText().toString();

            if(pass.equals("")){
                Toast.makeText(StudentActivity1.this,"Enter Password",Toast.LENGTH_SHORT).show();
            }
            else if(id==null){
                Toast.makeText(StudentActivity1.this,"Scan your ID",Toast.LENGTH_SHORT).show();
            }
                ...
                Toast.makeText(StudentActivity1.this,"Attendence Send Successfully",Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(StudentActivity1.this,"Incorrect Password",Toast.LENGTH_SHORT).show();
            }
        }
    }
}
