...
public class StudentDetails_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_details_3);

        setTitle("Today's Attendance");

        databaseReference = FirebaseDatabase.getInstance().getReference("Attendence3");

        total = (TextView)findViewById(R.id.totalAttendedStudentsID3) ;

        studentList = new ArrayList<>();
        customAdapter = new CustomAdapter2(StudentDetails_3.this,studentList);
