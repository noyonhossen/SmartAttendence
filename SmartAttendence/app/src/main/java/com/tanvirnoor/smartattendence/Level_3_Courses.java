...
public class Level_3_Courses extends AppCompatActivity {
    ListView listView;
    String student_or_teacher;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level_3__courses);
        ...
        listView=(ListView)findViewById(R.id.listViewId_3);
        final String[] list = getResources().getStringArray(R.array.list_level_3);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Level_3_Courses.this,R.layout.sample_layout_course,R.id.textViewId,list);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(student_or_teacher.equals("student")){
                    if(list[position].equals("ECE 425")){
                        Intent intent = new Intent(Level_3_Courses.this, StudentActivity1.class);
                    ...
                    Intent intent = new Intent(Level_3_Courses.this,TeacherLogin.class);
